...
const Profile = () => {
  ...
  return (
    <div className="bg-[#1b1c24] h-[100vh] flex items-center justify-center flex-col gap-10">
      <div className="flex flex-col gap-10 w-[90%] md:w-[80vw] lg:w-[60vw]">
          ...
          >
            <Avatar className="h-full w-full rounded-full overflow-hidden">
              {image ? (
                ...
                <div
                  className={`uppercase text-5xl border-[1px] flex items-center justify-center rounded-full ${getColor(selectedColor)} h-full w-full`}
                >
            ...
            {/* <input type="file" ref={fileInputRef} className="hidden" onChange={handleImageChange} name="profile-image" accept=".png, .jgp, .jpeg, .webp"/> */}
          </div>
        </div>
